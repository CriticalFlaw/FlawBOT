...
namespace FlawBOT.Modules
{
    ...
    public class SimpsonsModule : BaseCommandModule
    {
        ...
        [Command("simpsons"), Aliases("caramba")]
        ...
        [Command("simpsonsgif"), Aliases("doh")]
            ...
            string input)
        {
            ...
            var results = await SimpsonsService.GetSimpsonsDataAsync(SimpsonsService.SiteRoot.Frinkiac)
                .ConfigureAwait(false);
            results.WithFooter(Resources.WARN_GIF_LOADING);
        ...
        [Command("futuramagif"), Aliases("neat")]
        ...
        [Command("rickgif"), Aliases("mortygif")]
