...
namespace FlawBOT.Framework.Models
{
    ...
    public class TimeData
    {
        ...
        public class GeolocationModel
        {
            ...
            [JsonProperty("geometry")] public GeometryModel Geometry { get; set; }
        ...
        {
            [JsonProperty("dstOffset")] public double DstOffset { get; set; }

            [JsonProperty("rawOffset")] public double RawOffset { get; set; }
    ...
    public class Main
    {
        ...
        [JsonProperty("tempMin")] public double MinTemp { get; set; }

        [JsonProperty("tempMax")] public double MaxTemp { get; set; }
    }
