...
namespace FlawBOT.Framework.Services
{
    public class TeamFortressService : HttpHandler
    {
        ...
        public static async Task<List<Server>> GetGameServerInfoAsync(string query)
        {
            return await new TeamworkClient(TokenHandler.Tokens.TeamworkToken).GetGameServerInfoAsync(query).ConfigureAwait(false);
        }
        ...
        public static async Task<Provider> GetCommunityProviderAsync(string query)
        {
            return await new TeamworkClient(TokenHandler.Tokens.TeamworkToken).GetCommunityProviderAsync(query).ConfigureAwait(false);
        }

        public static async Task<List<Server>> GetCommunityProviderServersAsync(string query)
        {
            return await new TeamworkClient(TokenHandler.Tokens.TeamworkToken).GetCommunityProviderServersAsync(query).ConfigureAwait(false);
        }

        public static async Task<ProviderStats> GetCommunityProviderStatsAsync(string query)
        {
            return await new TeamworkClient(TokenHandler.Tokens.TeamworkToken).GetCommunityProviderStatsAsync(query).ConfigureAwait(false);
        }

        public static async Task<CompProvider> GetCompetitiveProviderAsync(string query)
        {
            return await new TeamworkClient(TokenHandler.Tokens.TeamworkToken).GetCompetitiveProviderAsync(query).ConfigureAwait(false);
        }

        public static async Task<CompProviderStats> GetCompetitiveProviderStatsAsync(string query)
        {
            return await new TeamworkClient(TokenHandler.Tokens.TeamworkToken).GetCompetitiveProviderStatsAsync(query).ConfigureAwait(false);
        }
        ...
        public static async Task<ServerList> GetSpecificServerListAsync(int query)
        {
            return await new TeamworkClient(TokenHandler.Tokens.TeamworkToken).GetSpecificServerListAsync(query).ConfigureAwait(false);
        }

        public static async Task<List<Server>> GetServersFromServerListAsync(int query)
        {
            return await new TeamworkClient(TokenHandler.Tokens.TeamworkToken).GetServersFromServerListAsync(query).ConfigureAwait(false);
        }
