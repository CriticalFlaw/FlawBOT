...
namespace FlawBOT.Modules
{
    ...
    {
        [SlashCommand("steam_connect", "Formats a server connection string into a link.")]
        ...
        [SlashCommand("steam_game", "Returns information on a Steam game.")]
        ...
        [SlashCommand("steam_user", "Returns information on a Steam user.")]
