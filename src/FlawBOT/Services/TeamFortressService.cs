    ...
    public class TeamFortressService : HttpHandler
    {
        ...
        public static DiscordEmbed GetSchemaItem(string query)
        {
            ...
            var output = new DiscordEmbedBuilder()
                ...
                .AddField("Giftable:", results.Capabilities.CanGiftWrap == true ? ":heavy_check_mark:" : ":x:", true)
                .AddField("Nameable:", results.Capabilities.Nameable ? ":heavy_check_mark:" : ":x:", true)
        ...
        public static async Task<DiscordEmbed> GetServersByGameModeAsync(string token, string query)
        {
            ...
            var output = new DiscordEmbedBuilder()
                ...
                .AddField("Password Lock", results.HasPassword ? ":heavy_check_mark:" : ":x:", true)
                .AddField("Random Crits", results.HasRandomCrits == true ? ":heavy_check_mark:" : ":x:", true)
                .AddField("Instant Respawn", results.HasNoRespawnTime ? ":heavy_check_mark:" : ":x:", true)
                .AddField("All Talk", results.HasAllTalk ? ":heavy_check_mark:" : ":x:", true)
