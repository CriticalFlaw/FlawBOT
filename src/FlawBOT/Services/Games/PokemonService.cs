...
namespace FlawBOT.Services.Games
{
    public class PokemonService
    {
        ...
        public static async Task<PokemonData> GetPokemonDataAsync(string query)
        {
            var data = await http.GetStringAsync(base_url + query.Trim());
            return JsonConvert.DeserializeObject<PokemonData>(data);
        }
        ...
        public readonly static List<string> Pokemon = new List<string>
        {
            "Abomasnow",
            "Abra",
            "Absol",
