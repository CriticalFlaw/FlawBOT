...
namespace FlawBOT.Common
{
    public class SharedData
    {
        ...
        public static string InviteLink = "https://discordapp.com/oauth2/authorize?client_id=339833029013012483&scope=bot";
        public static string GitHubLink = "https://github.com/criticalflaw/flawbot";
        public static DiscordColor DefaultColor = new DiscordColor("#7851A9");
